...
class Document implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('presignedUrl', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['presignedUrl'];
    }

    /**
     * Sets presignedUrl
     *
     * @param string|null $presignedUrl presignedUrl
     *
     * @return $this
     */
    public function setPresignedUrl(?string $presignedUrl): static
    {
        if (is_null($presignedUrl)) {
            array_push($this->openAPINullablesSetToNull, 'presignedUrl');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('presignedUrl', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['presignedUrl'] = $presignedUrl;
