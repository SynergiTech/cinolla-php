...
/**
 * Address2Country Class Doc Comment
 *
 * @package  SynergiTech\Cinolla
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class Address2Country implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Address2_country';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('c2Code', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getC2Code(): ?string
    {
        return $this->container['c2Code'];
    }

    /**
     * Sets c2Code
     *
     * @param string|null $c2Code c2Code
     *
     * @return $this
     */
    public function setC2Code(?string $c2Code): static
    {
        if (is_null($c2Code)) {
            array_push($this->openAPINullablesSetToNull, 'c2Code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('c2Code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['c2Code'] = $c2Code;
