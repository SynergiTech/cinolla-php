...
/**
 * CustomFormWorkflowMappingWorkflowActionMappableField Class Doc Comment
 *
 * @package  SynergiTech\Cinolla
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CustomFormWorkflowMappingWorkflowActionMappableField implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomFormWorkflowMapping_workflowActionMappableField';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fieldName', $data ?? [], '');
        $this->setIfExists('propertyName', $data ?? [], '');
